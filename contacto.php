<?php /* contacto.php - Página de contacto ABZCAR, Bootstrap 5, navbar y footer unificados */ ?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Contacto | ABZCAR</title>
...
<body>
    ...
    <div class="container my-5">
      <h1 class="mb-4 fw-bold text-center">Contacto</h1>
