<?php /* proyectos.php - Página de proyectos ABZCAR, Bootstrap 5, navbar y footer unificados */ ?>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Proyectos | ABZCAR</title>
...
<body>
    ...
    <div class="container my-5">
      <h1 class="mb-4 fw-bold text-center">Proyectos Realizados</h1>
      <div class="row">
        <div class="col-md-6 mb-4">
          <div class="card h-100 shadow-sm border-0">
            <img src="https://images.unsplash.com/photo-1502877338535-766e1452684a?auto=format&fit=crop&w=600&q=80" class="project-img" alt="Restauración de Mustang 1967">
            <div class="card-body">
              <h5 class="card-title">Restauración de Mustang 1967</h5>
              <p class="card-text">Reparación completa de motor y carrocería. <br><b>Fecha:</b> 2024-03-10</p>
            </div>
          </div>
        </div>
        <div class="col-md-6 mb-4">
          <div class="card h-100 shadow-sm border-0">
            <img src="https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=600&q=80" class="project-img" alt="Servicio de grúa a flotilla empresarial">
            <div class="card-body">
              <h5 class="card-title">Servicio de grúa a flotilla empresarial</h5>
              <p class="card-text">Traslado de 10 vehículos para empresa XYZ. <br><b>Fecha:</b> 2024-05-22</p>
            </div>
          </div>
        </div>
      </div>
